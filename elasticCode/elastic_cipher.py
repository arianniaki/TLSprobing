...
for uni in university:
		...
		for cipher in ciphers:
			for i in range(int(scroll_size)):
				#print (page['hits']['hits'][i]['_id'])
				cipher_suites = ((page['hits']['hits'][i]['_source']['valid_cipher']))
				#print ("ciphersuites",cipher_suites)
				#print("cipher:", cipher)
				for a in cipher_suites:
					if cipher == a:
						ciphersuite_dict[cipher] += 1


					#print(cipher,"YAY")
		print("UNIVERSITY:",uni)
		print(ciphersuite_dict)
